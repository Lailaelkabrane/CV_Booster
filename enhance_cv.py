...
def generate_cv_with_llm(
    ...
    # ── Determine CV output language ────────────────────────────────────────
    if cv_language == "fr":
        _cv_language = "French"
        log.info("✓ CV language forced: French (user choice)")
    elif cv_language == "en":
        _cv_language = "English"
        log.info("✓ CV language forced: English (user choice)")
    else:
        # Auto-detect from CV text
        ...
        log.info("✓ CV language auto-detected: %s (fr_signals=%d)", _cv_language, _fr_count)

    _language_instruction = (
        f"═══════════════════════════════════════════\n"
        f"CRITICAL LANGUAGE REQUIREMENT — NON-NEGOTIABLE:\n"
        f"Write the ENTIRE CV in {_cv_language.upper()}.\n"
        f"- Translate ALL content to {_cv_language} including profile, bullets, section headers\n"
        f"- Only proper nouns (names, companies, tools, cert titles) stay as-is\n"
        f"- Do NOT write a single sentence in any other language\n"
        f"═══════════════════════════════════════════"
    )
...
FINAL REMINDER: Write the ENTIRE CV output in {_cv_language.upper()}. Translate every word. Do not use any other language.
